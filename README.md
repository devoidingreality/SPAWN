W@nt\⃞\\\\_T0_k⃞nowkno��⃞wkn⃞ow_Wh��t_HaHa⃞Happened⃞_To/⃞//////////⃞_Them   ?
...
You will use `(getgenv and getgenv()) or shared` the most, so I recommend you learn more about the global environment soon. ███████'s Timeless API will be useful.
For Secretaries, you will use `saveinstance()` since your job is to compile as many worlds as possible.
